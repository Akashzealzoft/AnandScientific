...
const Header = () => {
  ...
  // Filter lab data based on search term
  ...
  const handleProductClick = () => {
    // Reset the search term and hide the search results
    setSearchTerm('');
  };
  ...
  return (
    <>
      <header
        className={`header h-200 left-0 top-0 z-40 flex w-full items-center ${sticky
        ...
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-evenly">
            <div className="w-60 hidden md:block  max-w-full px-4 xl:mr-12">
              ...
              >
                <Image
                  src="/images/logo/Anand-Black-Logo.png"
                  alt="logo"
                  width={110}
                  height={30}
                ...
                />
                <Image
                  src="/images/logo/Anand-White-Logo.png"
                  width={110}
                  height={30}
                  alt="logo"
            ...
            <div className="flex w-full items-center justify-between px-4">
              ...
              <div className=" md:flex-col flex-row flex items-center justify-evenly pr-16 lg:pr-0">
                <form className=" ">
      ...
      {searchTerm && filteredData.length > 0 && (
        <div className="flex mt-56 items-center justify-center mt-8">
          <div className="md:w-1/2  bg-white p-8 rounded shadow-lg">
            <h2 className="text-xl font-semibold mb-4">Search Results</h2>
            {filteredData.map((item) => (
              <div key={item.id} className="mb-4 border-b pb-4">
                <Link href={`/product/${item.id}`} passHref>
                  <div className="flex cursor-pointer " onClick={handleProductClick}>
                    <Image
                      src={item.image}
                      alt={item.name}
                      width={50}
                      ...
                      className="rounded"
                    />
                    <p className="text-blue-700 hover:underline mt-2">{item.name}</p>
                    {/* <p className="text-blue-700 hover:underline mt-2">{item.price}</p>
                    <p className="text-blue-700 hover:underline mt-2">{item.supply}</p>
                    <p className="text-blue-700 hover:underline mt-2">{item.color}</p> */}
                  </div>
                </Link>
              </div>
            ))}
...
//                 </nav>
//               </div>
//               <div className="flex items-center justify-evenly pr-16 lg:pr-0">
//                 <form className=" ">
//                   <label htmlFor="default-search" className="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white">
//                     Search
//                   </label>
//                   <div className="relative w-500 md:w-500">
//                     <div className="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
//                       <svg
//                         className="w-4 h-4 text-gray-500 dark:text-gray-400"
//                         aria-hidden="true"
...
//                   <div className="mr-4 bg-white p-6 rounded shadow-lg">
//                     <h2 className="text-lg font-semibold mb-4">Lab Data</h2>
//                     {filteredData.map((item) => (
//                       <div key={item.id} className="mb-2">
//                         <Link href={`/product/${item.id}`}>
//                           <div className="container">
//                             <ul>
//                               <li className="text-blue-700 hover:underline">{item.name}</li>
//                               <li>{item.image}</li>
//                             </ul>
//                           </div>
//                         </Link>
